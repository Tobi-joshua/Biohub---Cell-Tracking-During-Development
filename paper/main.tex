...
\thanks{Live application: \url{https://bioapp---cell-tracking-during-development-ezpjtah7icn2tfr8tie4.streamlit.app/}.%
Source code: \url{https://github.com/Tobi-joshua/Biohub---Cell-Tracking-During-Development}.}}
...
A publicly hosted Streamlit application enables inspection of raw volumes, detection overlays, temporal montages, track timelines, animated GIF exports, and graph tables suitable for publication without local installation.
...
The live demo is available at \url{https://bioapp---cell-tracking-during-development-ezpjtah7icn2tfr8tie4.streamlit.app/}.
\end{abstract}
...
The interactive application is publicly accessible at\\
\url{https://bioapp---cell-tracking-during-development-ezpjtah7icn2tfr8tie4.streamlit.app/}.
No account or local installation is required; users can load the bundled synthetic demo or upload a NumPy volume from the sidebar.
Source code, documentation, and figure-generation scripts are available at\\
\url{https://github.com/Tobi-joshua/Biohub---Cell-Tracking-During-Development}.
